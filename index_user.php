...
<head>
    ...
    <!-- normalize css -->
    <link rel = "stylesheet" href = "templateuser/css/normalize.css">
    <!-- custom css -->
    <link rel = "stylesheet" href = "templateuser/css/main.css">
</head>
<body>
        ...
        <nav class = "navbar bg-blue">
            <div class = "container flex">
                <a href = "index.html" class = "navbar-brand">
                    <img src = "templateuser/images/logo.png" alt = "site logo">
                </a>
                <button type = "button" class = "navbar-show-btn">
                    <img src = "templateuser/images/ham-menu-icon.png">
                </button>

                <div class = "navbar-collapse bg-white">
                    <button type = "button" class = "navbar-hide-btn">
                        <img src = "templateuser/images/close-icon.png">
                    </button>
                    <ul class = "navbar-nav">
                        <li class = "nav-item">
                        ...
                        <form>
                            <div class = "search-bar-box flex">
                                <span class = "search-icon flex">
                                    <img src = "templateuser/images/search-icon-dark.png">
                                </span>
        ...
        <div class = "header-inner text-white text-center">
            <div class = "container grid">
                ...
                <div class = "header-inner-right">
                    <img src = "templateuser/images/header.png">
                </div>
            </div>
        </div>
    </header>
            ...
            <div class = "about-inner">
                <div class = "container grid">
                    ...
                    <div class = "about-right flex">
                        <div class = "img">
                            <img src = "templateuser/images/about-img.png">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class = "container">
                <div class = "section-head text-center">
                    ...
                    <div class = "line-art flex">
                        <div></div>
                        <img src = "templateuser/images/4-dots.png">
                        <div></div>
                    </div>
                </div>
                <div class = "services-inner text-center grid">
                    <article class = "service-item">
                        <div class = "icon">
                            <img src = "templateuser/images/service-icon-1.png">
                        </div>
                    ...
                    <article class = "service-item">
                        <div class = "icon">
                            <img src = "templateuser/images/service-icon-2.png">
                        </div>
                    ...
                    <article class = "service-item">
                        <div class = "icon">
                            <img src = "templateuser/images/service-icon-3.png">
                        </div>
                    ...
                    <article class = "service-item">
                        <div class = "icon">
                            <img src = "templateuser/images/service-icon-4.png">
                        </div>
                        <h3>First Aid</h3>
                        <p class = "text text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis possimus doloribus facilis velit, assumenda tempora quas mollitia quos voluptatibus consequatur!</p>
                    </article>
        ...
        <section id = "banner-two" class = "banner-two text-center">
            <div class = "container grid">
                <div class = "banner-two-left">
                    <img src = "templateuser/images/banner-2-img.png">
                </div>
            ...
            <div class = "container">
                ...
                <div class = "doc-panel-inner grid">
                    <div class = "doc-panel-item">
                        <div class = "img flex">
                            <img src = "templateuser/images/doc-1.png" alt = "doctor image">
                    ...
                    <div class = "doc-panel-item">
                        <div class = "img flex">
                            <img src = "templateuser/images/doc-2.png" alt = "doctor image">
                            <div class = "info text-center bg-blue text-white flex">
                    ...
                    <div class = "doc-panel-item">
                        <div class = "img flex">
                            <img src = "templateuser/images/doc-3.png" alt = "doctor image">
                            <div class = "info text-center bg-blue text-white flex">
            ...
            <div class = "container">
                ...
                <div class = "posts-inner grid">
                    <article class = "post-item bg-white">
                        <div class = "img">
                            <img src = "templateuser/images/post-1.jpg">
                        </div>
                        <div class = "content">
                    ...
                    <article class = "post-item bg-white">
                        <div class = "img">
                            <img src = "templateuser/images/post-2.jpg">
                        </div>
                        <div class = "content">
                            <h4>Inspiring stories of person and family centered care during a global pandemic.</h4>
                            <p class = "text text-sm">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolor voluptas eius recusandae sunt obcaecati esse facere cumque. Aliquid, cupiditate debitis.</p>
                    ...
                    <article class = "post-item bg-white">
                        <div class = "img">
                            <img src = "templateuser/images/post-3.jpg">
                        </div>
                        <div class = "content">
                            <h4>Inspiring stories of person and family centered care during a global pandemic.</h4>
                            <p class = "text text-sm">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolor voluptas eius recusandae sunt obcaecati esse facere cumque. Aliquid, cupiditate debitis.</p>
        ...
        <div class = "container">
            <div class = "footer-inner text-white py grid">
                <div class = "footer-item">
                    ...
                    <div class = "icon">
                        <img src = "templateuser/images/logo.png">
                    </div>
    ...
    <!-- custom js -->
    <script src = "templateuser/js/script.js"></script>
</body>
</html>